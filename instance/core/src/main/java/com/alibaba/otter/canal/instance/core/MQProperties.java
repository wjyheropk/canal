...
public class MQProperties {
    ...
    public static class CanalDestination {
        ...
        public Map<String, String> getTableKey() {
            return tableKey;
        }

        public void setTableKey(Map<String, String> tableKey) {
        ...
        public void setIgnoreColumns(Map<String, List<String>> ignoreColumns) {
